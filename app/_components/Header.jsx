...
export const Header = () => {
  ...
  return (
    <header className="flex justify-between px-5 items-center gap-4 h-16 bg-A1">
      ...
      {params === '/home' || params === '/profile' || params === '/cards' || params === '/cards/add' || params === '/activity' || params === '/payments' || params === '/deposits' || params === '/services' ? <HomeHeader initialUser={initialUser} /> : <LandingHeader />}
    </header>
  )
}
