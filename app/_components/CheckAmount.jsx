  ...
  return (
    <div className="flex flex-col justify-center gap-4 bg-A1 rounded-lg w-[350px] md:w-[511px] lg:w-[1006px] lg:mr-16 h-auto m-4 p-4">
      ...
      <div className="flex justify-start items-center gap-2">
        <p className="text-white">Vas a transferir</p><Image width={30} height={30} src="/edit.svg" alt="check" />
      </div>
      <p className={`font-bold ${params === '/deposits/card/money/check' ? 'text-white text-xl' : 'text-A3 text-2xl'}`}>$ {amount}</p>
      <small className="text-white">Para</small>
      <p className={`font-bold ${params === '/deposits/card/money/check' ? 'text-white text-xl' : 'text-A3 text-2xl'}`}>Cuenta propia</p>
