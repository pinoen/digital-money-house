...
export const LandingMain = () => {
  return (
    <main className="flex-1 flex flex-col bg-[url('/user.svg')] md:bg-[url('/userMd.png')] lg:bg-[url('/userLg.png')] bg-center bg-cover bg-no-repeat min-h-0 h-[757px]">
      <div className="flex-1">
        ...
        <hr className="h-[8px] w-6 bg-A3 border-A3 my-4 ml-5 md:hidden" />
        ...
        <div className="flex flex-col lg:flex-row lg:justify-center lg:items-center gap-4 mt-20 p-5">
          <LandingBlock
      ...
      <div className="bg-A3 py-48 md:py-32 lg:py-20 w-full rounded-t-xl absolute bottom-0" />
    </main>
  );
};
