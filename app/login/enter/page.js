...
export default function Page() {
  ...
  return (
    <form className="flex flex-col justify-center items-center gap-4 bg-black h-screen" onSubmit={handleSubmit}>
      ...
      <button className="fullwidth h-12 w-[300px] bg-A3 text-black font-bold rounded text-center content-center" type="submit" disabled={isLoading}>Ingresar</button>
      {isError && <p className="text-red-500 text-sm">Credenciales incorrectas</p>}
    </form>
  );
}
